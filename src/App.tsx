    ...
    <>
            ...
            <StateButton
              ...
              onClick={() =>
                handleDeviceUpdate("livingRoom", "tv", {
                  ...
                  state:
                    deviceStates.livingRoom.tv.state === "on" ? "off" : "on",
                })
              }
            ...
            <StateButton
              ...
              onClick={() =>
                handleDeviceUpdate("kitchen", "stove", {
                  ...
                  state:
                    deviceStates.kitchen.stove.state === "on" ? "off" : "on",
                })
              }
      ...
      <footer className="bg-gray-800 text-white py-4 mt-8">
        <div className="container mx-auto text-center">
          <p>
            &copy; {new Date().getFullYear()} Casa Inteligente. Todos os
            direitos reservados. - <strong>Desenvolvido por:</strong> Gustavo
            Barros, Vitor Luckmann, Paulo Warmling
          </p>
        </div>
      </footer>
    </>
